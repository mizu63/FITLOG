...
const workoutsPage = async () => {
  ...
  return (
    <>
      ...
      <section className="bg-[#111214] py-7 sm:py-10">
        <div className="container mx-auto px-4 sm:px-6">

        
          <div className="mb-5 sm:mb-6">
            <h2 className="text-[24px] font-bold text-[#FFFFFF] sm:text-[30px]">
              THE LIBRARY
            </h2>

            <p className="mt-1 text-[12px] font-normal text-[#9CA3AF] sm:text-[14px]">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {workouts.map((workout) => (
              ...
              >
                ...
                <div className="relative h-[190px] w-full sm:h-[180px]">
                  <Image
                    src={workout.image}
                    alt={workout.name}
                    fill
                ...
                <div className="p-3 sm:p-4">
                  ...
                  <div className="mb-2 mt-1 flex flex-wrap gap-2">
                    {workout.muscleGroups.map((muscle) => (
                      <span
                        key={muscle}
                        className="rounded-full bg-[#C2F800] px-2 py-[3px] text-[9px] font-bold text-black sm:text-[11px]"
                      >
                        {muscle.toUpperCase()}
                      </span>
                    ))}
                  ...
                  <h3 className="text-[16px] font-bold uppercase text-white sm:text-[18px]">
                    {workout.name}
                  </h3>
