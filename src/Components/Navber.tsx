    ...
    <section className="container mx-auto">
      <nav className="flex justify-between items-center py-5 px-1">
        ...
        <ul className="flex items-center gap-6">
          <li
            className={`text-[12px] leading-3 font-medium ${pathname === links.workout
          ...
          <li
            className={`text-[12px] leading-3 font-medium ${pathname === links.myplan
                ? "text-[#C2F800] bg-[#1A2312] py-1.5 px-6 rounded-2xl"
                : "text-[#9CA3AF]"
              }`}
          >
        ...
        <div className="flex items-center gap-2.5">
          <button className="flex items-center gap-1 text-[12px] font-medium leading-2.5 text-[#D1D5DB] py-2 px-4">
            Plan
